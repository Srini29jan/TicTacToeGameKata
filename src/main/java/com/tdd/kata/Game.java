...
public class Game {
    ...
    public char getWinner() {
        ...
        if (isAnyRowFilledByPlayer(PLAYER_X)
                ...
                || isTopLeftToBottomRightDiagonalFilledByPlayer(PLAYER_X)) {
            winner = PLAYER_X;
        }
        ...
        if (isTopRightToBottomLeftDiagonalFilledByPlayerO(PLAYER_X)) {
            winner = PLAYER_X;
        }

        if (isTopRightToBottomLeftDiagonalFilledByPlayerO(PLAYER_O)) {
            winner = PLAYER_O;
        }
